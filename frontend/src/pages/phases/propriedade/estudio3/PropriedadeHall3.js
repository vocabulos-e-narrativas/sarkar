...
import PropriedadeCorridorN from "../../../../images/materialpisopitch/propriedade_intelectual/material_separado_propriedade_intelectual-03.png";

export default function PropriedadeHall3() {
    return (
        <div>
            <img src={PropriedadeCorridorN} useMap="#estudio3-map" className="img-100" />
            <map name="#estudio3-map">
                ...
                <area
                    ...
                    alt="estudio_3"
                    title=""
                    href="/phases/propriedade/estudio3/opening"
