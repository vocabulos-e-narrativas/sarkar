...
import Estudio1Longe from "../../../../images/materialpisopitch/material_separado_pitch-55.png";
import Porta2 from "../../../../images/oldsarkar/porta2.png";
...
export default function Opening() {
    ...
    useEffect(() => {
        const openDoors = setTimeout(() => {
            ...
            doorR.style.left = '78%';
            setTimeout(() => {
                navigate("/phases/pitch/estudio2/puzzle");
            }, 3000);
        }, 1000);
    }, [navigate]);
